...
{
	public partial class fBasDat06 : Form
    {
        public int myAction = 0;
        public Util.ObjectBasDat06 objRetorno = null;
        private bool isNew = false;

        public fBasDat06( Util.ObjectBasDat06 obj, bool is_New)
        {
            InitializeComponent();
            this.isNew = is_New;
            try
        ...
        private void fBasDat06_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnConfirmar_Click(object sender, EventArgs e)
        {
            ...
            {
                objRetorno = new Util.ObjectBasDat06();
