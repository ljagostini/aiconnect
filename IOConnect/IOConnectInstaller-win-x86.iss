...
;Source: Installer\VC_redist.arm64.exe; DestDir: "{tmp}"; Flags: deleteafterinstall; Check: InstallDotNetArm64; AfterInstall: InstallDotNet
;Source: Installer\VC_redist.x64.exe; DestDir: "{tmp}"; Flags: deleteafterinstall; Check: InstallDotNetX64; AfterInstall: InstallDotNet
