...
{
	public class DatPattern01 : IDat
    {
        ...
        public DatPattern01(string conteudo, int basePosicaoCircuito,
        ...
        public Dictionary<int, double> GetQuantidades()
        {
            ...
            for (int index = 0; index <= vShots.GetUpperBound(0); index += 2)
            {
                ...
                //double QUANTIDADE = 0;
                //if(EMB_DISP == 0 || EMB_REF == 0)
                //{
                //    QUANTIDADE = ((FATOR / FRACAO)) * SHOT;
                //}
                //else
                //{
                //    QUANTIDADE = ((FATOR / FRACAO) * (EMB_DISP / EMB_REF)) * SHOT;
                //}
